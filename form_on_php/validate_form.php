...
/**Функция filter_input () получает внешнюю переменную
 * (например, из ввода формы) и дополнительно фильтрует ее.
 * Эта функция используется для проверки переменных из
 * небезопасных источников, таких как пользовательский ввод.*/
